...
- `sdd/README.md` (rewritten), `sdd/day-log.spec.md`, `sdd/training-plan.spec.md`, `sdd/stats-dlq.spec.md`, `sdd/levenshtein-routine.md`, `sdd/stats-tests.md`, `sdd/docs-migration.md` (created/updated)
